  ...
  <div class="container">
    ...
    <div style="flex: 1; background-color: #f8f8f8">
      <div style="height: 50px;display: flex; align-items: center ;background-color: white ;padding-left: 20px">
        ...
        <span style="font-size: 24px; margin-left: 5px">闲置物品流通系统</span>
      </div>
...
<!--              <el-input size="medium" prefix-icon="el-icon-lock" placeholder="请添加头像" show-password  v-model="form.avatar"></el-input>-->
<!--            </el-form-item>-->

            <el-form-item>
              <el-button size="medium" style="width: 100%; background-color: orange; border-color: orange; color: white" @click="login">注 册</el-button>
            </el-form-item>
          </el-form>
        </div>
      </div>
